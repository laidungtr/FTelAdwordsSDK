...
Pod::Spec.new do |s|
  ...
  s.author             = { "" => "laidungtr@gmail.com" }
  # Or just: s.author    = ""
  # s.authors            = { "" => "laidungtr@gmail.com" }
  ...
  s.source       = { :git => "https://laidungtr@bitbucket.org/laidungtr/fteladwordssdk.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "FTelAdwordsSDK", "FTelAdwordsSDK/**/*.{h,m,swift}"
